...
<section class="section_editActors">

<h2 id='h2_editActors'>Editer Acteur</h2>

    <div class="editActors_wrapper">
        <form class='formular_base' action="" method="post">
            ...
            <input id="submit" type="submit" name="editActor" value="Editer">
        </form>
    </div>
